...
-- remap -> https://github.com/ThePrimeagen/init.lua/blob/master/lua/theprimeagen/remap.lua
...
-- Hardtime
keymap.set("n", "<leader>tt", "<cmd>Hardtime toggle<CR>", { desc = "Toggle hardtime" })

-- diagnostic (bqf/pqf)
keymap.set("n", "<leader>dx", vim.diagnostic.setloclist)
